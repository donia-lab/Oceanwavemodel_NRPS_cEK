function [maxi,F_logo]=SeqLogo_HRL(alignedseq,ntoraa,colormapping,letterclass,weight_thresh)
...
for i = 1:size(logoweights,2)
    logoweights(logoweights(:,i)<0,i)=0;
end
[max_f,I]=max(logoweights);
F_logo=logoletters(I)';
F_logo(max_f==0)='-';
maxi=0;
